...
public class RabbitConfig {
    ...
    public RabbitAdmin rabbitAdmin(ConnectionFactory connectionFactory) {
        ...
        rabbitAdmin.declareExchange(ExchangeBuilder.directExchange("flightStatusExchange").durable(true).build());
        // Declare a queue if needed
        // rabbitAdmin.declareQueue(QueueBuilder.durable("flightStatusQueue").build());
        return rabbitAdmin;
    }
}
